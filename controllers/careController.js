...
exports.getServiceById = async (req, res) => {
  try {
    const service = await Service.findById(req.params.id)
      .populate('provider', 'name email profilePicture role experience specialties');
...
exports.bookAppointment = async (req, res) => {
  try {
    const { serviceId, appointmentDate, timeSlot, petId, notes, location } = req.body;
...
exports.updateAppointmentStatus = async (req, res) => {
  try {
    ...
    if (providerNotes && appointment.provider.toString() === req.user._id.toString()) {
  ...
  try {
    ...
    const services = [
      // Veterinary Services
      {
        ...
        description: 'Comprehensive health examination for your pet including vital signs, weight check, and basic health assessment.',
        category: 'veterinary',
        price: 75,
        duration: 45,
        ...
        features: ['Digital records', 'Follow-up included', 'Vaccination reminder'],
        availability: [
      ...
      },
      {
        ...
        description: 'Complete vaccination package including core vaccines and health certificate.',
        category: 'veterinary',
        price: 120,
        duration: 30,
        ...
        features: ['All core vaccines', 'Health certificate', '1-year validity'],
        availability: [
          { day: 'monday', timeSlots: [{ start: '09:00', end: '17:00' }] },
          { day: 'tuesday', timeSlots: [{ start: '09:00', end: '17:00' }] },
          { day: 'wednesday', timeSlots: [{ start: '09:00', end: '17:00' }] },
      ...
      },
      {
        ...
        description: 'Professional dental cleaning and oral health examination for your pet.',
        category: 'veterinary',
        price: 200,
        duration: 90,
      ...
      // Grooming Services
      {
        ...
        description: 'Complete grooming package including bath, brush, nail trim, ear cleaning, and styling.',
        category: 'grooming',
        price: 85,
        duration: 120,
        ...
        features: ['Premium shampoo', 'Nail trimming', 'Ear cleaning', 'Styling'],
        availability: [
      ...
      },
      {
        ...
        description: 'Essential bath and brush service to keep your pet clean and fresh.',
        category: 'grooming',
        price: 45,
        duration: 60,
      ...
      // Training Services
      {
        ...
        description: 'Foundation training program covering basic commands and behavioral skills.',
        category: 'training',
        price: 150,
        duration: 60,
        ...
        features: ['4-week program', 'Take-home materials', 'Progress tracking'],
        availability: [
      ...
      },
      {
        ...
        description: 'Specialized program for puppies to develop social skills and confidence.',
        category: 'training',
        price: 120,
        duration: 45,
        ...
        features: ['Age-appropriate activities', 'Small groups', 'Play time included'],
        availability: [
      ...
      // Emergency Services
      {
        ...
        description: 'Round-the-clock emergency veterinary care for urgent situations.',
        category: 'emergency',
        price: 250,
        duration: 60,
        ...
        features: ['24/7 availability', 'Immediate response', 'Emergency equipment'],
        availability: [
...
exports.getAvailableSlots = async (req, res) => {
  try {
    ...
    dayAvailability.timeSlots.forEach(timeRange => {
      const slots = generateTimeSlots(timeRange.start, timeRange.end, service.duration);
      slots.forEach(slot => {
