      ...
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-3/5 p-8 md:p-12 lg:p-16">
              ...
              <p className="text-purple-100 mb-8 text-lg">
                Join thousands of happy pet owners who have found their perfect match through our platform. Whether you're looking to adopt, need temporary care, or want expert veterinary advice, we've got you covered.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  className="bg-white text-purple-600 px-6 py-3 rounded-lg font-semibold text-lg hover:bg-purple-100 hover:scale-105 transition-all duration-300 flex items-center justify-center shadow-md"
                >
                  <Heart size={20} className="mr-2" />
                  Find a Pet
                </button>
                <button
                  className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold text-lg hover:bg-white hover:text-purple-600 hover:scale-105 transition-all duration-300 flex items-center justify-center"
                >
                  Learn More
        ...
        <div className="mt-24 max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-purple-600 mb-2">300+</div>
